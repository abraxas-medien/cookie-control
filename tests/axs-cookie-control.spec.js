...
describe("axs-cookie-control plugin", function() {
	...
	describe('with no cookie saved before', function(){
		...
		describe('and the default settings', function(){
			beforeEach(function() {
		...
		describe('and the auto accept enabled', function(){
			...
			it('should become accepted when clicking', function(){
				var called = false;
				widgetElement.on('cookiecontrolchangedstatus', function(){
					called = true;
				});
	...
	describe('with the status set as accepted', function(){
		...
		describe('and the auto accept enabled', function(){
			...
			it('should\'t change the status when clicking', function(){
				var called = false;
